        ...
        <div style="background: white; width: 100%; border-radius: 20px 20px 0 0; max-height: 80vh; overflow-y: auto;">
          ...
          <div style="padding: 20px;">
            <div style="margin-bottom: 20px;">
              <p style="font-size: 14px; color: #666; margin-bottom: 10px;">Du mchtest tauschen gegen:</p>
            ...
            <div>
              <p style="font-size: 14px; color: #666; margin-bottom: 10px;">Whle einen deiner Artikel zum Tausch:</p>
              ${myItems.length === 0 ? `
